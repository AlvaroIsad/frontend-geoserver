...
var usuarios = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
...
var manzana = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
				layers:"manzana",
				format:"image/png",
				transparent:true
...
var lotes = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
				layers:"lotes",
				format:"image/png",
				transparent:true
...
var cnx_agua = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
...
var cnx_desague = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
...
var calles = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
                layers:"calles",
                format:"image/png",
                transparent:true
...
var ruta_lectura = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
                layers:"ruta lectura",
                format:"image/png",
                transparent:true
...
var ruta_reparto = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
                layers:"ruta reparto",
                format:"image/png",
                transparent:true
...
var secuencia_ruta_lectura = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
...
var secuencia_ruta_reparto = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
...
var sector = L.tileLayer.wms("http://localhost:8080/geoserver/catastro_huaraz/wms?",{
                layers:"fondo sector",
                format:"image/png",
                transparent:true
...
map.on('click', function(e) {
    if (identityActive) {
        ...
        var url = "http://localhost:8080/geoserver/catastro_huaraz/wms?" +
